...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  public SwerveSubsystem(File directory)
  {
    ...
    double angleConversionFactor = SwerveMath.calculateDegreesPerSteeringRotation((360/10.67*14));
  ...
  public void setupPathPlanner()
  {
    AutoBuilder.configure(
        ...
        new PPHolonomicDriveController( // HolonomicPathFollowerConfig, this should likely live in your Constants class
                                    new PIDConstants(4.5), new PIDConstants(4.5)
        ),
        new RobotConfig(55, 2817870, new ModuleConfig(.051, 4, 1.0, DCMotor.getNEO(4), 40, 1), 0), 
        () -> {
